We have analyzed orders file for Instacart to find out answers for some key questions listed below. This database includes only 1 file named “orders” and the analysis was done using Postgre SQL system.
